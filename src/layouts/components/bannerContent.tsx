    ...
    return(
      ...
      <div  className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-5 containerbanner">
        <div className="max-w-xl ltr:sm:text-left rtl:sm:text-right">
          ...
          {curlanguage.changeLanguage.value == "en" ? DataEn['quote1'].name : Data['quote1'].name}
          </h1>

          <p className="mt-4 max-w-lg sm:text-xl/relaxed">
          {curlanguage.changeLanguage.value == "en" ? DataEn['quote2'].name : Data['quote2'].name}
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-center">
            ...
            >
              {curlanguage.changeLanguage.value == "en" ? DataEn['bannertext1'].name : Data['bannertext1'].name}
            </a>
            ...
            >
              {curlanguage.changeLanguage.value == "en" ? DataEn['bannertext2'].name : Data['bannertext2'].name}
            </a>
          </div>
        </div>
      </div>

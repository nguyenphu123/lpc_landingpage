  ...
  value: {
    ...
    companyAddress: {
      address: [
        {
          content:
            "VP 5B-9B, Tòa nhà AS, 236-238 Nguyễn Công Trứ, P.Nguyễn Thái Bình, Quận 1, TP.HCM",
          contentEn:
            "VP 5B-9B, Tòa nhà AS, 236-238 Nguyễn Công Trứ, P.Nguyễn Thái Bình, Quận 1, TP.HCM",
          title: "",
        },
      ...
      addressLink: {
        content:
          "https://www.google.com/maps/place/Lien+Phat+Technology+Corporation+(C%C3%B4ng+Ty+C%E1%BB%95+Ph%E1%BA%A7n+C%C3%B4ng+Ngh%E1%BB%87+Li%C3%AAn+Ph%C3%A1t)/@10.7679955,106.6991394,17z/data=!4m6!3m5!1s0x31752f40068b5a77:0xf80e4fdadaba9c43!8m2!3d10.7677951!4d106.7002114!16s%2Fg%2F11cssys_4g?hl=vi-VN&entry=ttu",
        title: "",
      },
    },
    ...
    companyContact: [
      { type: "phonenumber", content: "28 3821 6688" },
      { type: "phonenumber", content: "28 3821 6684" },
      { type: "email", content: "info@lp.com.vn" },
    ],
    ...
    companyNewCatagory: ["Events", "Security"],
    companyNewTag: [
      "LPC",
      "Palo Alto Networks",
      "Platinum Innovator",
    ...
    companyNews: [
      {
        id: "post-1",
        title:
          "Hợp tác cung cấp giải pháp chuyển đổi số với công nghệ điện toán đám mây và trí tuệ nhân tạo",
        titleEn:
          "Hợp tác cung cấp giải pháp chuyển đổi số với công nghệ điện toán đám mây và trí tuệ nhân tạo",
        meta_title: "",
      ...
      },
      {
        ...
        titleEn: "Tấn công Ransomware ESXiArgs trên máy chủ VMware ESXi toàn cầu",
        meta_title: "",
        description: "this is meta description",
      ...
      },
      {
        ...
        titleEn: "Veeam sửa lỗi cho phép tin tặc xâm phạm cơ sở hạ tầng sao lưu",
        meta_title: "",
        description: "this is meta description",
        date: "2022-04-04T05:00:00Z",
    ...
    product: [
      ...
      },
      {
        ...
        link: "/cyber_security",
        type: "solution",
        description1: "LPC cung cấp các dịch vụ về mạng và an ninh mạng",
        description2:
      ...
      },
      {
        ...
        content: [
          {
            id: "system_maintain",
            title: "Bảo trì hệ thống/mạng core",
            content: "sp1",

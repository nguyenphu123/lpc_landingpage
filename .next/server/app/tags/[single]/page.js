...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 16208)), "C:\\Users\\Nguyen Ngoc Phu\\Documents\\GitHub\\website-lpc\\src\\app\\tags\\[single]\\page.tsx"],
...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 18275)), "C:\\Users\\Nguyen Ngoc Phu\\Documents\\GitHub\\website-lpc\\src\\app\\not-found.tsx"],
    ...
    const pages = ["C:\\Users\\Nguyen Ngoc Phu\\Documents\\GitHub\\website-lpc\\src\\app\\tags\\[single]\\page.tsx"];
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/tags/[single]/page","pathname":"/tags/[single]","bundlePath":"app/tags/[single]/page","filename":"","appPaths":[]}}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 78635));
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 31920));
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 40328))
...
;// CONCATENATED MODULE: ./src/layouts/components/BlogCard.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\Nguyen Ngoc Phu\Documents\GitHub\website-lpc\src\layouts\components\BlogCard.tsx`)
...
;// CONCATENATED MODULE: ./src/feature/changeLanguage/changeLanguageSlice.tsx

const initialState = {
    value: "vn"
};
const changeLanguge = (0,redux_toolkit_cjs_production_min.createSlice)({
    name: "language",
    initialState,
    reducers: {
...
/* harmony default export */ const changeLanguageSlice = (changeLanguge.reducer);

;// CONCATENATED MODULE: ./src/feature/data/dataSlice.tsx

const dataSlice_initialState = {
    value: {
        id: "1",
...
const searchCompany = (0,redux_toolkit_cjs_production_min.createSlice)({
    name: "search",
    initialState: dataSlice_initialState,
    reducers: {
        companyData: (state)=>{
        // Redux Toolkit allows us to write "mutating" logic in reducers. It
        // doesn't actually mutate the state because it uses the Immer library,
...
/* harmony default export */ const dataSlice = (searchCompany.reducer);

// EXTERNAL MODULE: ./src/lib/utils/textConverter.ts
var textConverter = __webpack_require__(15915);
;// CONCATENATED MODULE: ./src/lib/utils/taxonomyFilter.ts

const taxonomyFilter = (posts, name, key)=>posts.filter((post)=>//@ts-ignore
        post.frontmatter[name].map((name)=>(0,textConverter/* slugify */.lV)(name)).includes(key));
/* harmony default export */ const utils_taxonomyFilter = (taxonomyFilter);

// EXTERNAL MODULE: ./src/layouts/partials/PageHeader.tsx + 1 modules
var PageHeader = __webpack_require__(30108);
// EXTERNAL MODULE: ./src/layouts/partials/SeoMeta.tsx
var SeoMeta = __webpack_require__(36490);
// EXTERNAL MODULE: ./node_modules/next/navigation.js
var navigation = __webpack_require__(64980);
// EXTERNAL MODULE: ./node_modules/react-redux/lib/index.js
var lib = __webpack_require__(23044);
;// CONCATENATED MODULE: ./src/app/tags/[single]/page.tsx
...
const TagSingle = ()=>{
    const curlanguage = (0,lib.useSelector)(language);
    const params = (0,navigation.useParams)();
    const companyInfo = (0,lib.useSelector)(company);
    const posts = companyInfo.data.value.companyNews;
    const filterByTags = utils_taxonomyFilter(posts, "tags", params.single);
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(SeoMeta/* default */.ZP, {
                title: (0,textConverter/* humanize */.OI)(params.single)
            }),
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                    ...
                    children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "row",
                        children: filterByTags.map((post, index)=>/*#__PURE__*/ jsx_runtime_.jsx("div", {
...
/* harmony default export */ const page = (TagSingle);
...
var __webpack_exports__ = __webpack_require__.X(0, [266,990,712,855,914,527,635,328,108], () => (__webpack_exec__(90483)));
